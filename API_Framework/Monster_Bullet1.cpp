...
monster_Bullet1::monster_Bullet1()
{
...
void monster_Bullet1::Initialize()
{
	Speed = 4.0f;
...
int monster_Bullet1::Update(Transform& _rTransInfo)
{
...
void monster_Bullet1::Render(HDC _hdc)
{
